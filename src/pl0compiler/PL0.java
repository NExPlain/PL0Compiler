...
public class PL0 {
    ...
    public static final String pcodeFile = "./src/test/pcode/4.txt";
    public static final String tableFile = "./src/test/table/4.txt";
    public static final String runtimeFile = "./src/test/runtime/4.txt";
    public static final String errFile = "./src/test/error/4.txt";
    public static final String inputFile="./src/test/input/4.txt";
